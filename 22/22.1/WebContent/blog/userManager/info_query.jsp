    ...
    <td width="644" align="center" valign="top" bgcolor="#FFFFFF"><br>    
      ...
      <table width="547" border="0" cellpadding="0" cellspacing="0">
       <s:iterator value="%{#request.list}" id="info">
        <tr  height="30">
          <td> <input value="<s:property value="#info.id"/>" type="checkbox" name="id" class="button" id="chk_id">&nbsp;<s:property value="#info.info_account"/>:<s:property value="#info.info_content"/></td>
        </tr>
        </s:iterator>    
		<tr  height="30">
