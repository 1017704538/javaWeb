...
<table width="900" height="33" border="0" align="center" cellpadding="0" cellspacing="0" background="images/b_top4.gif">
  ...
  <tr align="center">
    <td height="20"><s:a href="userInfo_goinUser.htm?account=%{#session.userInfo.account}">我的文章</s:a>&nbsp;&nbsp;|&nbsp;&nbsp;<s:a href="photoInfo_fphoto_query.htm">我的相册</s:a>&nbsp;&nbsp;|&nbsp;&nbsp;<s:a href="blog/blog_individual.jsp">我的资料</s:a>&nbsp;&nbsp;|&nbsp;&nbsp;<s:a href="blog/blog_friends.jsp">我的好友</s:a></td>
    </tr>
</table>
