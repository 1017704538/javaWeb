...
<table width="1004" height="437" border="0" align="center"
	...
	<tr>
		...
		<table border="0" align="center" cellpadding="0" cellspacing="0">
			<tr>
				<td width="175" height="125" rowspan="4"><a
					href="media_show.jsp?id=<%=mediaInfo.getId()%>" class="cannleLine"><img
					src="<%=mediaInfo.getMediaPic()%>" width="175" height="125"></a></td>
		...
		<table width="685" border="0" align="center" cellpadding="0"
			cellspacing="0">
			<tr>
				<td>
				<hr>
