...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<table width="100%" border="0" align="center" cellpadding="0"
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td style=""><s:property value="user.userName" />的文章</td>
					<td>&nbsp;</td>
				</tr>
			</table>
			</td>
		...
		<table width="95%" height="56" border="0" align="center"
			...
			<tr>
				...
				<table width="100%" height="62" border="0" cellpadding="0"
					...
					<tr>
						<td class="huise1"><a
							href="articleAction_querySingleArticle.action?article.articleId='<s:property value="#article.articleId"/>'"
							target="_blank" class="daohangh"><s:property
					...
					<tr>
						<td class="huise1"><span class="henhong">发表日期</span> <s:property
							value="#article.emitTime" /> &nbsp;&nbsp;<a
							href="articleAction_querySingleArticle.action?article.articleId='<s:property value="#article.articleId"/>'"
							class="huise">查看详细>></a></td>
					</tr>
				</table>
				</td>
			</tr>
