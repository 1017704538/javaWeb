...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<table width="100%" border="0" align="center" cellpadding="0"
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td><s:if test="user.userName!=null">
						<s:property value="user.userName" />的文章列表
					  </s:if><s:else>
					    符合条件的文章列表
					  </s:else></td>
					<td>&nbsp;</td>
	...
	<table width="100%" height="26" border="0" align="center"
		...
		<!-- <tr>
		<td width="17%" class="huise1">每页显示 20 条 &nbsp;&nbsp;总共200 条</td>
		<td width="83%" class="huise1"><s:iterator value="myArticles"
			id="article" status="st">
		...
		<table width="100%" height="56" border="0" align="center"
			...
			<tr>
				...
				<table width="100%" height="62" border="0" cellpadding="0"
					...
					<tr>
						<td class="huise1"><s:a
							action="articleAction_querySingleArticle.action" target="_blank"
							cssClass="daohangh">
					...
					<tr>
						...
						&nbsp;&nbsp;<s:a action="articleAction_querySingleArticle.action"
							cssClass="huise">查看详细>>
						<s:param name="article.articleId" value="#article.articleId"></s:param>
						</s:a></td>
					</tr>
...
<script language="JavaScript" type="text/javascript">
     ...
     data.push(forum);
     data.push(article_search.init('<s:property value="article.articleTypeName"/>','<s:property value="searchStr"/>'));
     new PathUtil(data)
  </script>
</html>
