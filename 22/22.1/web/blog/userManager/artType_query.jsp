...
<title>${session.account}的博客后台管理-文章类别查询</title>
</head>
<script language="javascript">
function openUpdateArt(type){
		var hdc=window.open('blog/userManager/artType_update.jsp?type='+type,'','width=480,height=147');
		width=screen.width;
...
<table width="900" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="EBF1FD">
  <tr>
	...
	<s:else>
	<s:form action="userInfo_artType_delete.htm" name="form1">
	 <table width="500" height="29" border="0" cellpadding="0" cellspacing="0">  
      <tr> <td>       
	     <s:iterator value="%{#request.art_types}" id="type" status="st">
...
<table width="274" height="29" border="0" cellpadding="0" cellspacing="0">
    <s:form action="userInfo_artType_query">
      <tr>        
        <td width="157"><s:textfield name="artType"/></td>
	...
	<br>
	<s:fielderror>
	<s:param value="%{'ary_type'}"/></s:fielderror>    </td>
  </tr>
</table>
